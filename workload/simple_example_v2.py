...
from workload.schemas.workload_schema_v2 import workload_schema
...
df_tasks = pd.DataFrame([
    ["1", start_time, 1, 1_000, 10_000],
], columns=["id", "submission_time",
...
writeTrace(df_tasks, df_fragments, workload_schema, "traces/v2/simple_workload")
